...
* **UI** Converted Spire Update modal to EQ UI. (@Akkadius)
* **Items** Fix issue where the item search filters would get reset when hovered into the list preview pane. (@Akkadius)
* **Spire Admin** Fixed pre-flight World timeout issue where world would time out in 2 minutes. This is problematic for slower database migrations or slower database backups with large databases. The timeout has been increased to 10 minutes. (@Akkadius)
...
* **Spire Admin** Add permission settings for player event log ETL settings. (@joligario)
...
* **Spell Editor** Add more spell constants (@joligario)
* **Spell Editor** Adds a formula pane with known formulas (@joligario)
* **Spell Editor** Change spell effect formula to number input (@joligario)
* **Spell Editor** Fixes the `Resist Adjust` part of the NPC Spell Editor. Data type was set to `text` when it should have been `number` (@joligario)
* **Spell Editor** Unresistable is part of the `resisttype` group (@joligario)
* **Spire Admin** Add `etl_enabled` to Player Event Log Settings (@joligario)
* **Spire Admin** Add support for custom database version in server update page (@joligario)
...
* **Task Editor** Add faction_amount (@joligario)
...
[![429200358-c87a8a6b-22c5-4d95-bd15-52b3ba7889a0.png](https://i.postimg.cc/CKp5c8xL/429200358-c87a8a6b-22c5-4d95-bd15-52b3ba7889a0.png)](https://postimg.cc/LJvmXnPr)

[![429200433-67be055c-4008-4b4c-b897-085703bd0fc0.png](https://i.postimg.cc/HL0xRLr0/429200433-67be055c-4008-4b4c-b897-085703bd0fc0.png)](https://postimg.cc/8F5NrNBs)

[![429200467-804a19ef-bbdf-4d94-a0d5-53f3d1588a17.png](https://i.postimg.cc/jdCD2K1K/429200467-804a19ef-bbdf-4d94-a0d5-53f3d1588a17.png)](https://postimg.cc/svdj0Fy0)

[![429200502-6053a320-5405-4c6b-b143-c94424d1e313.png](https://i.postimg.cc/jqMWRCZZ/429200502-6053a320-5405-4c6b-b143-c94424d1e313.png)](https://postimg.cc/s1ZfcfFh)

[![429200544-e16650a7-538c-4098-8c72-fdd1accce5a4.png](https://i.postimg.cc/nhDMK2ZP/429200544-e16650a7-538c-4098-8c72-fdd1accce5a4.png)](https://postimg.cc/RWvM4cW7)

[![429200772-f34ddffe-8d41-49cb-b755-525893d6a5ac.png](https://i.postimg.cc/X7hpymM5/429200772-f34ddffe-8d41-49cb-b755-525893d6a5ac.png)](https://postimg.cc/Yh6p5XC2)

[![429200883-cafcf95f-019a-480f-a688-370a0bb0b0ea.png](https://i.postimg.cc/2y93GXVP/429200883-cafcf95f-019a-480f-a688-370a0bb0b0ea.png)](https://postimg.cc/64R95cV0)
...
* **Spire Admin** Stability improvements to distributed launcher.
...
![image](https://github.com/EQEmu/spire/assets/3319450/ea4293cf-cb7f-47c5-8858-6e246af86c22)

![image](https://github.com/EQEmu/spire/assets/3319450/6177c73c-8faf-40aa-9a8e-1144319031b8)
...
![image](https://github.com/EQEmu/spire/assets/3319450/e6887073-c268-4fd4-a9ac-6b3d51a22e39)

![image](https://github.com/EQEmu/spire/assets/3319450/0b037f27-e493-401d-9dca-3fe4d07fae9d)
...
![image](https://github.com/EQEmu/spire/assets/3319450/eb5ee780-e48f-469e-8040-fd21b7a0e0fe)

![image](https://github.com/EQEmu/spire/assets/3319450/aa7adbbc-c56e-4dcf-83d6-750eae8d63c6)
...
![image](https://github.com/EQEmu/spire/assets/3319450/c0e7e515-a3d2-4345-bb25-56f1696fb57f)

![image](https://github.com/EQEmu/spire/assets/3319450/74ea9159-68e4-422a-ba83-af1588492243)

![image](https://github.com/EQEmu/spire/assets/3319450/8c87292e-775c-40a2-9238-3724af75a5a0)
...
![image](https://github.com/EQEmu/spire/assets/3319450/29f34cb6-6961-4287-aadd-cd99a3644c5b)

#### S3D / EQG Zone Region Inspector

![image](https://github.com/EQEmu/spire/assets/3319450/1c88abc3-25a9-4562-a869-976fee530a44)
...
![image](https://github.com/EQEmu/spire/assets/3319450/b0576ea5-0ce4-4062-a456-768985faca4b)
...
* Add command `spire:occulus-update` to update Occulus to the latest version or install it if it doesn't exist [#116](https://github.com/EQEmu/spire/pull/116)
...
* Spire will now exit immediately after updating if no terminal is attached [#114](https://github.com/EQEmu/spire/pull/114)
* Spire web interface port can now be configured using **eqemu_config.json** @ **spire.http_port** if it exists or environment variable `SPIRE_HTTP_PORT` if it exists [#112](https://github.com/EQEmu/spire/pull/114)
* Add command `spire:init [username] [password] --auth-enabled=true` to initialize a new Spire install with a default admin [#113](https://github.com/EQEmu/spire/pull/114)
* Add command `user:change-password [username] [password]` to change a user's password [#113](https://github.com/EQEmu/spire/pull/114)
...
* Item editor edit button now is a hyperlink that can be opened in a new tab https://github.com/EQEmu/spire/issues/106
* Item editor clone button now is a hyperlink that can be opened in a new tab https://github.com/EQEmu/spire/issues/106
* Item editor now can deeply link to tabs
* Added "Food" tab with proper item display values in item card preview https://github.com/EQEmu/spire/issues/100
* Added proper "zero value" for skillmodtype and extradmgskill (Thanks Kinglykrab)

### Spell Editor

* Add "Corruption" to resist types https://github.com/EQEmu/spire/issues/92
* Spell editor now can deeply link to tabs
* Have DB String buttons open a new tab to prevent loss of progress in editor https://github.com/EQEmu/spire/issues/95

### Merchant Editor

* Fix an issue with new merchantlist entries creating a max_status of 0 preventing new merchant items from being displayed https://github.com/EQEmu/spire/issues/107

### NPC / Bot Spells Editor

* Fix an issue where editing a spell results in a number type error https://github.com/EQEmu/spire/issues/83

### Quest API Explorer

* Fix an issue with copy to clipboard for multiple events being displayed in search https://github.com/EQEmu/spire/issues/104
* Added user preference default language https://github.com/EQEmu/spire/issues/98

### Fixes

* Fixed [Bug] Merchant Editor creates new merchant list entries with max status of 0 https://github.com/EQEmu/spire/issues/107
...
* Addresses an issue where connections endpoint was hit when booting the app. When Spire does not have a Spire database, it panics the backend. https://github.com/EQEmu/spire/issues/63
...
Implemented searching by method param. [#23](https://github.com/EQEmu/spire/issues/23)
...
* Fixed a bug where sub event examples for Lua were not formatted properly [#21](https://github.com/EQEmu/spire/issues/21)
...
here [https://github.com/EQEmu/spire](https://github.com/EQEmu/spire)
...
here [https://github.com/EQEmu/spire/releases](https://github.com/EQEmu/spire/releases)
