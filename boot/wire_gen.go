// InitializeApplication wires the app explicitly without code generation.
...
import (
	...
	"github.com/EQEmu/spire/internal/http/middleware"
...
func InitializeApplication() (App, error) {
	...
	botBlockedBuffController := crudcontrollers.NewBotBlockedBuffController(resolver, userEvent)
	...
	botSettingController := crudcontrollers.NewBotSettingController(resolver, userEvent)
	...
	characterEvolvingItemController := crudcontrollers.NewCharacterEvolvingItemController(resolver, userEvent)
	...
	characterPetNameController := crudcontrollers.NewCharacterPetNameController(resolver, userEvent)
	...
	dynamicZoneLockoutController := crudcontrollers.NewDynamicZoneLockoutController(resolver, userEvent)
	...
	itemsEvolvingDetailController := crudcontrollers.NewItemsEvolvingDetailController(resolver, userEvent)
	...
	playerEventAaPurchaseController := crudcontrollers.NewPlayerEventAaPurchaseController(resolver, userEvent)
	playerEventKilledNamedNpcController := crudcontrollers.NewPlayerEventKilledNamedNpcController(resolver, userEvent)
	playerEventKilledNpcController := crudcontrollers.NewPlayerEventKilledNpcController(resolver, userEvent)
	playerEventKilledRaidNpcController := crudcontrollers.NewPlayerEventKilledRaidNpcController(resolver, userEvent)
	...
	playerEventLootItemController := crudcontrollers.NewPlayerEventLootItemController(resolver, userEvent)
	playerEventMerchantPurchaseController := crudcontrollers.NewPlayerEventMerchantPurchaseController(resolver, userEvent)
	playerEventMerchantSellController := crudcontrollers.NewPlayerEventMerchantSellController(resolver, userEvent)
	playerEventNpcHandinController := crudcontrollers.NewPlayerEventNpcHandinController(resolver, userEvent)
	playerEventNpcHandinEntryController := crudcontrollers.NewPlayerEventNpcHandinEntryController(resolver, userEvent)
	playerEventSpeechController := crudcontrollers.NewPlayerEventSpeechController(resolver, userEvent)
	playerEventTradeController := crudcontrollers.NewPlayerEventTradeController(resolver, userEvent)
	playerEventTradeEntryController := crudcontrollers.NewPlayerEventTradeEntryController(resolver, userEvent)
	...
	sharedbankController := crudcontrollers.NewSharedbankController(resolver, userEvent)
