          ...
          <div class="stat-section col-4">
            <table style="width:100%">
              ...
              <tr v-for="(data, stat) in stats">
                ...
                <!-- Heroic -->
                <td style="text-align: right" v-if="parseInt(itemData[data.heroic]) !== 0">
          ...
          <div class="stat-section col-4">
            <table style="width:100%">
              ...
              <tr v-for="(data, stat) in resists">
                ...
                <!-- Heroic -->
                <td style="text-align: right; color: #ffecca" v-if="parseInt(itemData[data.heroic]) !== 0">
          ...
          <div class="stat-section col-4">
            <table style="width:100%">
              ...
              <tr v-for="(field, stat) in mod3">
                ...
                <!-- Label -->
                <td style="font-weight: bold" v-if="parseInt(itemData[field]) !== 0">
                  {{ stat }}
                </td>

                <!-- Regular stat -->
                <td style="text-align: right" v-if="parseInt(itemData[field]) !== 0">
                  {{ itemData[field] }}
                </td>
